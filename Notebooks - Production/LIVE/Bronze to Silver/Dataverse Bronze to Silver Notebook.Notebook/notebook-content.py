...
customer_cfg = {
    ...
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_customers",  
...
item_uom_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_itemunitsofmeasure",
...
employee_rfid_mapping_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_employeerfidmapping",  
...
machine_center_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_machinecenter",  
...
cell_list_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_cellemaillist",  
...
emp_in_cell_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_silver_cell_employee",  
...
npd_worklogs_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/dts_npd_worklogs",
...
routing_steps_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_npd_routingsteps",
...
sketch_mapping_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_npd_sketchmapping",
...
sketch_master_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_npd_sketchmaster",
...
cad_requests_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/dts_cadrequests",
...
engineer_time_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/dts_engineertimelog",
...
sketch_manager_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/dts_npd_cadversions",
...
sketch_customer_approval_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/dts_npd_customerapproval",
...
sketch_size_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/dts_npd_childcadsizerequest",
...
sketch_size_master_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/dts_npd_cadsizerequest",
...
printing_batch_master_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_npd_3dprintingbatchmaster",
...
printing_batch_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_npd_3dprintingbatch",
...
wax_receive_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_npd_waxreceive",
...
pd_step_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/dts_npd_cadroutingsteps",
...
sketch_collection_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/dts_npd_collection",
...
issue_header_cfg = {
    # ---- SOURCE ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_subcontractissueheaders",
...
issue_lines_cfg = {
    # ---- SOURCE ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_subcontractissuelines",
...
plating_prep_jig_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_platingprep_jig",
...
sub_contract_price_list_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_subcontpricegrouplist",
...
sub_contract_deduction_lines_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_subcontractdeductionlines",
...
firm_plan_log_cfg = {
    # ---- SOURCE (Bronze Delta table path) ----
    "source_path": "abfss://Dataverse@onelake.dfs.fabric.microsoft.com/dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.Lakehouse/Tables/cr535_firmplan_log",
...
# MAGIC FROM Dataverse.dataverse_ennovieprodu_cds2_workspace_unq09bbc58ecdb9ee119073000d3a099.dts_jcwaxtometalratiomaster
